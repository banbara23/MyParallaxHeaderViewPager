...
//	private AlphaForegroundColorSpan mAlphaForegroundColorSpan;
    ...
    private boolean isHideFirstCell = false;
	@Override
...
//		mHeaderPicture.setResourceIds(R.drawable.pic0, R.drawable.pic1);
        ...
        mHeader_title = (TextView)findViewById(R.id.header_title);
...
//            Log.i("onScroll","mViewPager.getCurrentItem:" + mViewPager.getCurrentItem() + " pagePosition:" + pagePosition + " firstVisibleItem:"+firstVisibleItem + " visibleItemCount:"+visibleItemCount);
...
//			interpolate(mHeaderLogo, getActionBarIconView(), sSmoothInterpolator.getInterpolation(ratio));
            ...
            mHeader_title.setVisibility(View.VISIBLE);
            mHeaderLogo.setVisibility(View.VISIBLE);
		}
        if (isHideFirstCell) {
            mHeader_title.setVisibility(View.GONE);
	...
	public int getScrollY(AbsListView view) {
		...
		if (firstVisiblePosition >= 1) {
            ...
            isHideFirstCell = true;
		}
        else {
            isHideFirstCell = false;
        }
//        Log.i("getScrollY","headerHeight:"+headerHeight + " firstVisiblePosition:" + firstVisiblePosition);
